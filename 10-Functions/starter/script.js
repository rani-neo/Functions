...
//with the number of replies for each option. This data is stored in the starter object 
//below.
//
//Here are your tasks:
//
...
//
//BONUS: Use the 'displayResults' method to display the 2 arrays in the test data. Use 
//both the 'array' and the 'string' option. Do NOT put the arrays in the poll object! So 
//what shoud the this keyword look like in this situation?
//
...
And now explain to YOURSELF (or someone around you) WHY this worked! Take all the time 
you need. Think about WHEN exactly the callback function is executed, and what that 
...
(function () {
    ...
    header.style.color = 'red'; // Initial color set to red

    document.querySelector('body').addEventListener('click', function () {
        if (header.style.color !== 'blue') {
            header.style.color = 'blue'; // Change color to blue after first click
        }
    });
})();
